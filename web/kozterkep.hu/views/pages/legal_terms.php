<div class="row">
  <div class="col-md-9">
    <p class="text-muted text-right">Frissítve: 2019.04.22.</p>


    <h4 class="subtitle">Kivonat</h4>

    <p>A legfontosabbnak tartott részek egyszerűsített és rövid kivonata. A weblap használatával a teljes szöveget el kell fogadnod.</p>

    <ul>
      <li>A feltöltött képi állományok és szöveges leírások jogtulajdonosa az adott állomány feltöltője, amennyiben nem harmadik fél által létrehozott művek.</li>
    ...
    <h4 class="subtitle mt-5">II. Szerzői jogok, felhasználás</h4>

    <p>Az itt részletezett szerzői jogok a III. részben leírtak együttes alkalmazásával érvényesek.</p>

    <h5>A.) Képi anyagok</h5>
    <p>A képek felhasználhatósága egyedileg változó.</p>

    <p>1. A Köztérképen elérhető fényképfelvételek felhasználásának pontos feltételét a képek nagy méretben történő megnyitását követően megjelenő "Felhasználási jogok" részletezi. Amennyiben Creative Commons alatt közzétett állományt használnál, követned kell az adott licensz alatt leírtakat.</p>

    <p>2. Amennyiben a felhasználási feltétel előírja a forrás megnevezését, abban az esetben a helyes megjelölés: "Szerző neve / Köztérkép".</p>

    <p>3. Amennyiben a kép mellett a "Nincs engedély" kitételt látod, csak és kizárólag a feltöltő írásos engedélyével használhatod fel a fotót. Ehhez regisztrált tagként bejelentkezve lépj kapcsolatba a feltöltővel.</p>

    <p>4. Internetes felhasználás esetén linkelendő a felvételt tartalmazó műlap webcíme. Az oldalról letöltött adatok módosítása csak annyira és olyan módon engedélyezett, amely feltétlenül szükséges a kitűzött cél megvalósításához és ami összhangban van a kapott engedéllyel.</p>

    <p>5. Amennyiben a "Ne változtasd" kitétel is szerepel a felhasználhatóságban, úgy a képen látható vízjel levágása a továbbközlési jog elvesztését jelenti.</p>
    ...
    <h5>C.) Adatok</h5>
    <p>A Köztérkép fentieken (A, B) túli adatai közkincsnek minősülnek.</p>

    <p>Adatnak minősül minden olyan adatbázis elem, amely nem képi anyag, valamint nem egybefüggő szöveges bemutatás. Például: mű címe, alkotó neve, avatás ideje, földrajzi adatok és koordináták, paraméterek, nézettség és más statisztikák, stb.</p>

    <h5>D.) Egyéb rendelkezések</h5>
    <p>1. Felhasználás esetén a Köztérkép nem vállal közvetítői szerepet, a felhasználó az adott fényképfelvételek szerzői jogait birtokló személyekkel kell, hogy felvegye a kapcsolatot.</p>

    <p>2. Amennyiben letöltöd és/vagy kinyomtatod a Köztérkép bármely oldalát, az újonnan létrejött példányon köteles vagy feltüntetni a szerzői és ahhoz hasonló más tulajdonosi jogokat.</p>

    <h4 class="subtitle mt-5">III. Szerzői jogokkal kapcsolatos általános rendelkezések</h4>
    <p>1. Amennyiben a Köztérképre bármilyen szellemi terméket, véleményt, fényképet töltesz fel, vagy juttatsz el, vállalod, hogy ezen szöveges és képi tartalmakat az Üzemeltető minden további díjfizetési kötelezettségtől mentesen időben és térben korlátlanul felhasználhatja, publikálhatja (a szerzői jogról szóló 1999. évi LXXVI. törvény [a továbbiakban: Sztv.] 16. §. (1), (4) bekezdései értelmében). A feltöltött szövegeket és képeket az Üzemeltető harmadik fél weboldalán megjelenítheti, egészben vagy részleteiben egyaránt. Az Üzemeltető a Köztérképre való tartalomfeltöltéssel összefüggő szolgáltatásokért sem anyagi, sem más ellenszolgáltatást nem kér – és nem is kérhet, így a feltöltött szövegek illetve képek megjelenítéséért honoráriumot fizetni nem tud. Ennek értelmében a Köztérkép egy virtuális műalkotás/köztéri alkotás leírás- és képgyűjtemény.</p>

    <p>2. A Köztérképre csak saját szerzői jogú illetve szabadon felhasználható (Sztv. 33. § - 34. §) szövegeket és képeket tölthetsz fel.</p>

    <p>3. Jelen jogi nyilatkozat tudomásulvételével elfogadod és magadra érvényesnek tekinted, hogy nem töltesz fel szerzői jog, üzleti titoktartás által védett elemeket, valamint bármit, ami személyiségi jogokat sérthet, kivételt képez e szabály alól az az eset, ha a feltöltő ezen jogok tulajdonosa és ezekről döntést hozhat, vagy ha a feltöltő a jogok tulajdonosától érvényes és hivatalos felhatalmazást kapott.</p>

    <p>4. A Köztérképen található képek szerzői jogi védelem alá eshetnek. Az Üzemeltető nem vállal felelősséget a Köztérképre feltöltött esetleges szerzői joggal védett képek jogosulatlan megjelenítéséért, mivel a képeket a Köztérkép felhasználói töltötték fel / küldték be. Az Üzemeltetőnek nem áll módjában ellenőrizni a beküldött képek felhasználásának jogosultságát, ez a feltöltő felhasználó felelőssége. Amennyiben a feltöltött és a feldolgozásra került képek készítője, a tulajdoni jogok birtokosa, illetve képviselője bármely jogát vagy érdekét az internetes oldalon történt publikálás sérti, kérésére az oldalon lévő szerzői jogokkal érintett termékét az Üzemeltető eltávolítja.</p>

    <p>5. Regisztrációddal elfogadod, hogy feltöltéseid az Üzemeltető, vagy az általa megbízott szerkesztők jóváhagyásával kerülnek ki a publikusan elérhető weboldalakra. A feltöltés ellenőrzését követően Üzemeltető nem köteles publikálni a beküldést, ha az nem felel meg az oldal jogi szabályainak, vagy feltöltési elveinek.</p>

    <p>6. Feltöltéseid regisztrációd esetleges törlését követően a Köztérképen maradnak, azok nem kerülnek automatikus törlésre.</p>

    <h4 class="subtitle mt-5">IV. Felelősség kizárása</h4>
    <p>1. Bármely az internetes oldalon vagy azon keresztül elérhető anyagokért az Üzemeltető bizalmassági és/vagy biztonsági felelősséget nem vállal.</p>

    <p>2. Az Üzemeltető nem vállal felelősséget azért, ha a Köztérképen valamely műalkotás leírás vagy kép, alkotói, település vagy más adat hibásan, hiányosan vagy nem megfelelő kategóriában szerepel.</p>

    <p>3. Az Üzemeltető nem minden esetben ellenőrzi és vizsgálja felül a felhasználók által feltöltött szövegeket, képeket és megjegyzéseket mielőtt azok harmadik fél számára is hozzáférhetővé válnak. A megtekinthető anyagok tartalmazhatnak egyesek által kifogásolható, elfogadhatatlan vagy sértő elemeket. Az Üzemeltető nem tudja garantálni ezen elemek automatikus eltávolítását az internetes oldalról, valamint esetleges előfordulásuk esetén felelősséget nem vállal.</p>

    <p>4. Nem tehetsz közzé törvénybe ütköző, obszcén, rágalmazó, fenyegető, erotikus, pornográf, fajilag vagy etnikailag sértő vagy bármilyen más módon el nem fogadható tartalmakat, illetve nem is linkelheted ezeket.</p>

    <p>5. A saját magad által feltöltött, a Köztérképen közzétett és bárki által elérhető tartalmakért illetve azok bármilyen következményéért kizárólagos felelősséget kell vállalnod.</p>

    <p>6. Az Üzemeltető a műalkotásokhoz kerülő adatokat csak megjeleníti, azok tartalmával nem feltétlenül ért egyet, és a tartalomért felelősséggel nem tartozik. A beküldött adatok az oldalon azonnal, cenzúrázatlanul megjelenhetnek.</p>

    <p>7. Nem közölhetsz szándékosan rossz információk alapján kidolgozott vagy arra vezető tartalmakat, melyek így károsíthatják az Üzemeltetőt és/vagy bármely harmadik felet.</p>

    <p>8. Az Üzemeltető a Köztérkép használatából származó károkért felelősséggel nem tartozik.</p>

    <p>9. Az Üzemeltető és/vagy bármely munkatársa felelősséget nem vállal és felelősségre nem vonható semmilyen, a következőkben felsorolt esetben: bármilyen természetű anyagi vagy nem anyagi károsodás esetén, mely a Köztérkép használata során keletkezik, a Köztérkép adatbázisba történő bármilyen illetéktelen behatolás esetén és az ott található személyes adatok felhasználása esetén, a Köztérkép oldalról és/vagy a Köztérkép oldalra történő adatátvitel bármilyen formájú megszakítása vagy megszüntetése esetén, bármely, a Köztérkép oldal vagy társoldalainak használata során letöltött vírusfertőzés esetén.</p>
    ...
    <p>6. A weboldalon kerülendő a feltöltött adatok reklámcélú és -jellegű megjelenítése (pl.: szoborkészítő cég kiemelt megjelenítése). Adatbázisunk független, önkéntes és nonprofit, így semmilyen anyagi forrásokból működő gazdasági társaságnak nem biztosítunk reklámfelületet, olyan tevékenységért cserébe, amelyekért ezen gazdasági szervezetek anyagi ellenszolgáltatásban részesültek.</p>

    <p>6. A Köztérképre való regisztrációval elfogadod többek közt a jelen Jogi nyilatkozatot. A fentieken túlmenően a jelen nyilatkozat elfogadásával kifejezetten lemondasz azon jogodról, hogy a fenti nyilatkozatot bármilyen okból vagy módon módosítsd vagy visszavond. Szavatolod továbbá, hogy jelen nyilatkozat megtételére jogosult vagy, az nem sért szerzői és egyéb jogokat.</p>
