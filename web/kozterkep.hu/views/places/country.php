<div class="row kt-info-box p-2 pt-3 pt-md-2 mb-4">
  ...
  <div class="col-md-7 col-lg-8 py-2">
    <?=$country_id == 101 ? 'Magyarország' : 'Az ország'?> <strong><?=_n($place_count)?></strong> településének <strong><?=_n($artpiece_count)?> alkotása</strong> található meg nálunk.
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-md-6 col-lg-5">
    ...
    <?=$app->element('places/index/top_places', ['options' => ['query' => ['orszag' => $country_id]]])?>
