...
class ImageResize {
   ...
   * @param string $orientation_correction - @hekk hagyjuk ki a forgatást, mert mi forgattunk
   * @return ImageResize
   * @throws Exception
   */
  public function __construct($filename, $orientation_correction = true) {
    ...
    switch ($this->source_type) {
      ...
      case IMAGETYPE_JPEG:
        $this->source_image = $this->imageCreateJpegfromExif($filename, $orientation_correction);
  ...
  public function imageCreateJpegfromExif($filename, $orientation_correction = true) {
