...
return [
  ...
  'counties' => [
    1 => ['Budapest', 1756],
    2 => ['Pest vármegye', 1234],
    3 => ['Győr-Moson-Sopron vármegye', 455],
    4 => ['Vas vármegye', 253],
    5 => ['Zala vármegye', 275],
    6 => ['Veszprém vármegye', 344],
    7 => ['Komárom-Esztergom vármegye', 297],
    8 => ['Fejér vármegye', 418],
    9 => ['Nógrád vármegye', 193],
    10 => ['Heves vármegye', 299],
    11 => ['Borsod-Abaúj-Zemplén vármegye', 660],
    12 => ['Jász-Nagykun-Szolnok vármegye', 376],
    13 => ['Szabolcs-Szatmár-Bereg vármegye', 563],
    14 => ['Hajdú-Bihar vármegye', 534],
    15 => ['Somogy vármegye', 309],
    16 => ['Tolna vármegye', 223],
    17 => ['Baranya vármegye', 363],
    18 => ['Bács-Kiskun vármegye', 511],
    19 => ['Csongrád-Csanád vármegye', 404],
    20 => ['Békés vármegye', 347],
  ],
